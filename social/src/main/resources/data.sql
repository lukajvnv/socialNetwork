...
INSERT INTO SETTING(NAME, TYPE) VALUES ('set key 2', 'boolean');
INSERT INTO SETTING(NAME, TYPE) VALUES ('set key 3', 'boolean');
...
--  VALUES (1, 'admin@gmail.com', '$2a$08$qvrzQZ7jJ7oy2p/msL4M0.l83Cd0jNsX6AJUitbgRXGzge4j035ha', FALSE, FALSE, FALSE, TRUE, 'ROLE_ADMIN', 'Admin', 'Adminovic', '1996-03-29');
INSERT INTO USER(ID, USER_NAME, PASSWORD, ACCOUNT_EXPIRED, ACCOUNT_LOCKED, CREDENTIALS_EXPIRED, ENABLED, ROLE, FIRST_NAME, LAST_NAME, BIRTHDAY)
...
INSERT INTO USER(ID, USER_NAME, PASSWORD, ACCOUNT_EXPIRED, ACCOUNT_LOCKED, CREDENTIALS_EXPIRED, ENABLED, ROLE, FIRST_NAME, LAST_NAME, BIRTHDAY, GENDER, ACTIVE_SINCE, ABOUT, OCCUPATION, ADDRESS)
  VALUES (3, 'user2@gmail.com', '$2a$08$cE.IOuWuYcfgGAlgP5N/RuCd7bUWobIpv0xxlZsH76uSEx/1rZNsG', FALSE, FALSE, FALSE, TRUE, 'ROLE_USER', 'User2', 'Korisnikovic', '1996-03-01', 'Male', '2020-09-13', 'I am cool SW guy', 'Sw student', 'Stevana Milovanova');
INSERT INTO USER(ID, USER_NAME, PASSWORD, ACCOUNT_EXPIRED, ACCOUNT_LOCKED, CREDENTIALS_EXPIRED, ENABLED, ROLE, FIRST_NAME, LAST_NAME, BIRTHDAY, GENDER, ACTIVE_SINCE, ABOUT, OCCUPATION, ADDRESS)
...
INSERT INTO MESSAGE (SENDER_ID, RECEIVER_ID, TEXT, SEND_TIME) VALUES (2, 3, 'Proba...', '2020-09-10');
INSERT INTO MESSAGE (SENDER_ID, RECEIVER_ID, TEXT, SEND_TIME) VALUES (3, 2, 'Proba2...', '2020-09-14 16:48:00');
INSERT INTO MESSAGE (SENDER_ID, RECEIVER_ID, TEXT, SEND_TIME) VALUES (3, 4, 'Proba3...', '2020-09-14 16:55:00');

INSERT INTO POST (AUTHOR_ID, TEXT, FEELING, POST_TIME, STYLE, IMAGE_URI, FILE_URI) VALUES (3, 'New post by user2', 'exited', '2020-09-11 16:55:00', 'green', 'circle.jpg', 'IT_kratak_pregled.pdf');
INSERT INTO POST (AUTHOR_ID, TEXT, FEELING, POST_TIME) VALUES (3, 'New post by user2', 'sad', '2020-09-12 16:55:00');
INSERT INTO POST (AUTHOR_ID, TEXT, FEELING, POST_TIME, STYLE) VALUES (3, 'New post by user2', 'love', '2020-09-14 16:55:00', 'green');
INSERT INTO POST (AUTHOR_ID, TEXT, FEELING, POST_TIME, STYLE) VALUES (2, 'New post by user1', 'Exited', '2020-09-11 16:59:00', 'green');


INSERT INTO COMMENT (AUTHOR_ID, POST_ID, TEXT, COMMENT_TIME) VALUES (3, 1, 'New comment', '2020-09-03 16:55:00');
